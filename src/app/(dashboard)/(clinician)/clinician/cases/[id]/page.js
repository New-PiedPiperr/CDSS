      ...
      >
        {biodata ? (
          <div className="grid grid-cols-2 gap-6 md:grid-cols-3">
            ...
            {biodata.height != null && (
              <DataField label="Height" value={`${biodata.height} m`} />
            )}
            {biodata.weight != null && (
              <DataField label="Weight" value={`${biodata.weight} kg`} />
            )}
            {biodata.notes && (
        ...
        {analysis ? (
          <div className="space-y-6">
            ...
            <div className="from-primary/10 to-primary/5 rounded-2xl bg-gradient-to-br p-6">
              ...
              <h3 className="text-3xl font-black">{stripMarkdown(analysis.temporalDiagnosis)}</h3>
