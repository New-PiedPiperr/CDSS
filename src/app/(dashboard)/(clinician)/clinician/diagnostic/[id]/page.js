    ...
    <div className="mx-auto w-full max-w-4xl px-3 pb-6 sm:px-4 sm:pb-8">
      ...
      <div className="space-y-6">
        {tests.map((test) => (
          <div
            key={test.id}
            className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:p-6 dark:border-gray-700 dark:bg-gray-800"
          >
            {/* Test Title */}
            ...
            {/* Instructions */}
            <div className="mb-4">
              <h4 className="mb-2 text-xs font-semibold text-gray-900 sm:text-sm dark:text-gray-100">
                Instructions
              </h4>
            ...
            <div className="mb-3 overflow-hidden rounded-lg bg-gray-700 sm:mb-4 dark:bg-gray-900">
              <div className="flex aspect-video items-center justify-center">
                <button className="flex h-16 w-16 items-center justify-center rounded-full bg-white/90 text-gray-900 transition-transform hover:scale-110 sm:h-20 sm:w-20">
            ...
            {/* Alert */}
            <div className="mb-4 flex items-start gap-2 sm:mb-5">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              <button className="flex-1 rounded-lg bg-cyan-500 px-4 py-2 text-xs font-medium text-white transition-colors hover:bg-cyan-600 sm:flex-none sm:px-8 sm:text-sm">
                Follow
              </button>
              <button className="flex-1 rounded-lg bg-cyan-500 px-4 py-2 text-xs font-medium text-white transition-colors hover:bg-cyan-600 sm:flex-none sm:px-8 sm:text-sm">
                Negative
              </button>
              <button className="w-full rounded-lg bg-cyan-500 px-4 py-2 text-xs font-medium text-white transition-colors hover:bg-cyan-600 sm:w-auto sm:px-8 sm:text-sm">
                Update to positive
              </button>
            </div>
          </div>
